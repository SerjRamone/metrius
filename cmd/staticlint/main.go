...
import (
	...
	"github.com/SerjRamone/metrius/pkg/osexitanalyzer"
...
func main() {
	...
	// all "SA*" analyzers and some otners
	yetAnother := map[string]bool{
		"S1000":  true,
		"S1002":  true,
		"S1006":  true,
		"S1028":  true,
	...
	for _, v := range staticcheck.Analyzers {
		if strings.HasPrefix("SA", v.Analyzer.Name) || yetAnother[v.Analyzer.Name] {
